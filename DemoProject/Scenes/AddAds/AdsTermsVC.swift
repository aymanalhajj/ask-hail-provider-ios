...
class AdsTermsVC: UIViewController {
...
extension AdsTermsVC {
    ...
    func CheckPackge() {
        ...
        ApiServices.instance.getPosts(methodType: .post, parameters: nil , url: "\(hostName)business-add-advertisement/level2-check-package") { (data : AddAdsSelectPackageModel?, String) in
