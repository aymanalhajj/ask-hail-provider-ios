...
class AdsPaymentBankVC: UIViewController {
...
extension AdsPaymentBankVC : UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc  = storyboard.instantiateViewController(withIdentifier: "AdsConfirmTransferVC") as! AdsConfirmTransferVC
        vc.Model = self.Model
        vc.state = self.state
