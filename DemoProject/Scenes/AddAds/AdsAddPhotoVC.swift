...
class AdsAddPhotoVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lbl.text = "(maximum 2 video)".localized
...
extension AdsAddPhotoVC {
    ...
    func uploadMedia(){
        ...
        ApiServices.instance.uploadImage(methodType: .post, parameters: Param as [String : AnyObject], url: "\(hostName)business-add-advertisement/level4-add-media", imagesArray: images, profileImage: CoverImage.image, commercial_register_image: nil, office_license_image: nil, id_image: nil, VediosArray: VediosArray, VediosDuration: VedioDuration){ (data : FixedPagesModel?, String) in
