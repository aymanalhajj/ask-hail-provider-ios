...
extension AdsConfirmTransferVC {
    ...
    func AddNewPackage() {
        ...
        ApiServices.instance.getPosts(methodType: .post, parameters: param as [String : AnyObject] , url: "\(hostName)business-add-advertisement/add-package") { (data : Level_1_Model?, String) in
