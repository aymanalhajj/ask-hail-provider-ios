...
extension DeleteAskPopupVC {
    ...
    func DeletASk() {
        ...
        ApiServices.instance.getPosts(methodType: .post, parameters: Parameters as [String : AnyObject] , url: "\(hostName)business/delete-question") { (data : Level_6_Model?, String) in
